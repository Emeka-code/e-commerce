...
const SignUp = () => {
  const [image, setImage] = useState("/fone1.png");
  ...
  const onSummit = handleSubmit(async (value) => {
    ...
    const mainURL = "https://diary-backend-clinton.herokuapp.com";
      ...
      <Container>
        <Wrapper>
          <Card>
            <MainTitle>
              <Title>
                <BsFillJournalBookmarkFill /> ReadMe.
              </Title>

              <SubTitle>
                Coded By <strong>CLINTON EKEGBU</strong>{" "}
              </SubTitle>
            </MainTitle>
